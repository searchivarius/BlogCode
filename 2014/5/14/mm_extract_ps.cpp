...
int main(int,char**) {
  __m128 v = _mm_set_ps(0.4, 0.3, 0.2, 0.1);

  cout << MM_EXTRACT_FLOAT(v, 0) << endl;
  cout << MM_EXTRACT_FLOAT(v, 1) << endl;
  cout << MM_EXTRACT_FLOAT(v, 2) << endl;
  cout << MM_EXTRACT_FLOAT(v, 3) << endl;
