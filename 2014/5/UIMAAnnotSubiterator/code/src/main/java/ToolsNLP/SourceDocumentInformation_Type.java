...
public class SourceDocumentInformation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ToolsNLP.SourceDocumentInformation");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "ToolsNLP.SourceDocumentInformation");
  ...
  public int getOffsetInSource(int addr) {
      ...
      jcas.throwFeatMissing("offsetInSource", "ToolsNLP.SourceDocumentInformation");
  ...
  public int getDocumentSize(int addr) {
      ...
      jcas.throwFeatMissing("documentSize", "ToolsNLP.SourceDocumentInformation");
  ...
  public boolean getLastSegment(int addr) {
      ...
      jcas.throwFeatMissing("lastSegment", "ToolsNLP.SourceDocumentInformation");
