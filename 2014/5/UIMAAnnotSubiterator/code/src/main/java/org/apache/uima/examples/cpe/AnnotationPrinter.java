...
public class AnnotationPrinter extends CasConsumer_ImplBase {
	...
	public void initialize(UimaContext context)
		...
		String oFileName = (String) context.getConfigParameterValue("outputFile");
		oConsole = (Boolean) context.getConfigParameterValue("printToConsole");
		if (oConsole == null) oConsole = false;
