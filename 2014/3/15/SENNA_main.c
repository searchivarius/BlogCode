...
static void help(const char *name)
{
  ...
  printf("\n");
  printf(" Takes sentence (one line per sentence) on stdin or a named pipe\n");
  printf(" Outputs tags on stdout or a named pipe\n");
  printf(" Typical usage: %s [options] < inputfile.txt > outputfile.txt\n", name);
  printf(" Typical usage: %s [options] -input_pipe <pipe name> -output_pipe <pipe name> \n", name);
  printf("\n");
  ...
  printf("  -maxsentsize   Maximum sentence size (default %ld)\n", max_sent_size);
  printf("\n");
