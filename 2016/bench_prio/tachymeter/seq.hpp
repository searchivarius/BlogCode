...
template <typename G>
inline
cpp14::enable_if_t<is_generator<cpp14::decay_t<G>>::value, power_t<cpp14::decay_t<G>>>
powers(G &&g, std::size_t floor, std::size_t ceil, std::size_t mul)
{
  return power_t<cpp14::decay_t<G>>(std::forward<G>(g), floor, ceil, mul);
}

template <typename ... T>
inline
cpp14::enable_if_t<all_are<std::is_integral, T...>::value,
...
cpp14::enable_if_t<
    ...
    seq_t<cpp14::decay_t<G>>>
seq(G &&g, T ... t)
{
  return seq_t<cpp14::decay_t<G>>(std::forward<G>(g), t...);
}
