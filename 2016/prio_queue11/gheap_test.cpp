...
// 
// We are going to use only C++11 code, so GHEAP_CPP11 is defined in gheap.hpp
//
...
TEST(vector_test, "gheap", "vector") {
  main_test<vector<int> >("vector");
}

TEST(deque_test, "gheap", "deque") {
